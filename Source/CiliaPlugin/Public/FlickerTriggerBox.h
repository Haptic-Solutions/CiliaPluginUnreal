...
#include "FlickerTriggerBox.generated.h"

/**
 * 
 */
UCLASS()
class CILIAPLUGIN_API AFlickerTriggerBox : public ATriggerBox
{
	GENERATED_BODY()
private:
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "CiliaFunctions")
		...
		*/
		void FlickerEffect(CiliaGroupsList CiliaGroup, class AActor* aPlayerCharacter, float DeltaTime, float SpeedDividerMinOffset, float SpeedDividerMax, uint8 Red, uint8 Green, uint8 Blue, bool FlickerAllTogether);
	/**
	*Default Constructor.
	*/
	AFlickerTriggerBox();
